...
func AddFunds(db dbBeginner) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		// Log de fondos agregados
		logger.Info("savings_goal.add_funds", "Fondos agregados a meta de ahorro", map[string]interface{}{
			"goal_id":     goalID,
